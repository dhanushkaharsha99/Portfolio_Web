...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">DHANUSHKA HARSHA
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Passionate about crafting elegant digital experiences,
            I am a budding software engineer proficient in  Continuously 
            learning and exploring new technologies. I aim to create impactful 
